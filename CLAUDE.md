...
- **Config**: `.env` (LLM_API_KEY, AI_MODEL), `conf.py:CAMPAIGN_CONFIG` (timing/ML defaults), `conf.py` schedule constants (active hours/timezone/rest days), Campaign/LinkedInProfile models (Django Admin).
